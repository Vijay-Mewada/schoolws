    ...
    return (
        <div className='relative  '>
            ...
            <div className='flex flex-wrap'>
                ...
                <h1 className='text-center font-bold text-xl font-serif my-4'>Director Message</h1>
                ...
                <img src={require('../image/director.jpg')} alt='upper' className='p-1 mt-3 rounded-full flex mx-auto' style={{height:'450px',width:'450px'}}  />
